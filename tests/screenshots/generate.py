...
- Playwright intercepts the volatile endpoints (``/api/now-playing``,
  ...
  ``/api/settings``, ``/api/playlists/tracked``, ``/api/playlists/discover``)
  so the captures are byte-stable and never leak real credentials.
...
def _release_please_version() -> str:
    ...
    Keeps the demo version pill in sync with the real release automation
    ...
    try:
        ...
        return "0.0.0"
    return str(data.get(".", "0.0.0"))


DEMO_VERSION = _release_please_version()

VIEWPORT = {"width": 1440, "height": 900}
DEVICE_SCALE = 2

_TRACKED_PLAYLISTS: list[dict] = [
    {
        "title": "Last.fm Recents (auto)",
        "id": "PLdemoMainPlaylist000000000001",
        "category": "main",
        "autogenerated": True,
        "confidence": 0.98,
        "tracked": True,
    ...
    {
        "title": "Ambient Focus (auto)",
        "id": "PLdemoCustomAmbient0000000001",
        "category": "custom",
        "autogenerated": True,
        "confidence": 0.95,
        "tracked": True,
    ...
    {
        "title": "Favorite Artists (auto)",
        "id": "PLdemoCustomArtists00000000001",
        "category": "custom",
        "autogenerated": True,
        "confidence": 0.95,
        "tracked": True,
    ...
    {
        "title": "Indie Folk Sundays (auto)",
        "id": "PLdemoCustomFolk00000000000001",
        "category": "custom",
        "autogenerated": True,
        "confidence": 0.95,
        "tracked": True,
    ...
    {
        "title": "Last.fm Recents (auto) week of 2026-05-25",
        "id": "PLdemoWeekly0000000000020260525",
        "category": "weekly",
        "autogenerated": True,
        "confidence": 0.97,
        "tracked": True,
    ...
    {
        "title": "Last.fm Recents (auto) week of 2026-05-18",
        "id": "PLdemoWeekly0000000000020260518",
        "category": "weekly",
        "autogenerated": True,
        "confidence": 0.97,
        "tracked": True,
...
_UNTRACKED_PLAYLISTS: list[dict] = [
    {
        "title": "Last.fm Recents (auto) week of 2026-05-11",
        "id": "PLdemoWeekly0000000000020260511",
        "category": "weekly",
        "autogenerated": True,
        "confidence": 0.97,
        "tracked": False,
    ...
    {
        "title": "Last.fm Recents (auto) week of 2026-05-04",
        "id": "PLdemoWeekly0000000000020260504",
        "category": "weekly",
        "autogenerated": True,
        "confidence": 0.97,
        "tracked": False,
...
_DISCOVERED_PLAYLISTS = _TRACKED_PLAYLISTS + _UNTRACKED_PLAYLISTS
...
ROUTE_STUBS: dict[str, dict] = {
    ...
    "**/api/playlists/tracked": {"candidates": _TRACKED_PLAYLISTS},
    "**/api/playlists/discover": {"candidates": _DISCOVERED_PLAYLISTS},
    "**/api/settings": {
    ...
    env.update(
        {
            ...
            "CACHE_SEARCH_TTL_DAYS": "36500",
            "CACHE_NOTFOUND_TTL_DAYS": "36500",
            "TAG_CACHE_TTL_DAYS": "36500",
            "LASTFM_USER": "demo_user",
            "LASTFM_API_KEY": "demo_api_key_00000000000000000000",
            "PLAYLIST_NAME": "Last.fm Recents (auto)",
            "WEEKLY_ENABLED": "true",
...
def capture_playlists(context, base_url: str, out: Path) -> None:
    page = _open_dashboard(context, base_url)
    page.evaluate("window.switchTab && window.switchTab('playlists')")
    page.wait_for_selector('[data-tab="playlists"].active', state="visible")
    page.evaluate("window.discoverPlaylists && window.discoverPlaylists()")
    with contextlib.suppress(Exception):
        page.wait_for_selector("#playlistsList .pl-card", state="visible", timeout=4_000)
    page.wait_for_timeout(300)
    page.evaluate("const c = document.getElementById('toastContainer'); if (c) c.innerHTML = ''")
    page.wait_for_timeout(100)
    _shoot(page, out, "playlists")
...
CAPTURES["playlists"] = capture_playlists
