const actionHandlers = {
  ...
  previewSync: () => window.previewSync(),
  runSyncFromPreview: () => window.runSyncFromPreview(),
  ...
  clearLocalLastfm: () => window.clearLocalLastfm(),
  confirmClearLocalLastfm: () => window.confirmClearLocalLastfm(),
  localLastfmExport: () => window.localLastfmExport(),
  showLocalLastfmDataModal: () => window.showLocalLastfmDataModal(),
  confirmLocalLastfmImportMerge: () => window.confirmLocalLastfmImportMerge(),
  confirmLocalLastfmImportReplace: () => window.confirmLocalLastfmImportReplace(),
  ...
  dismissEnvUpdateBanner: () => window.dismissEnvUpdateBanner(),
  importMissingSettings: () => window.importMissingSettings(),
  downloadEnvExample: () => window.downloadEnvExample(),
  testWebhook: () => window.testWebhook(),
  appriseAdd: () => window.appriseAdd(),
  appriseTestNew: () => window.appriseTestNew(),
  appriseTestEntry: el => window.appriseTestEntry(el.dataset.index),
  appriseToggleEntry: el => window.appriseToggleEntry(el.dataset.index),
  appriseDeleteEntry: el => window.appriseDeleteEntry(el.dataset.index),
  ...
  syncCustomPlaylist: el => window.syncCustomPlaylist(parseInt(el.dataset.index, 10)),
  previewCustomPlaylist: el => window.previewCustomPlaylist(parseInt(el.dataset.index, 10)),
  showSyncPlaylistsModal: () => window.showSyncPlaylistsModal(),
  syncPlaylistsSelectAll: () => window.syncPlaylistsSelectAll(),
  syncPlaylistsSelectNone: () => window.syncPlaylistsSelectNone(),
  confirmSyncPlaylists: () => window.confirmSyncPlaylists(),
